...
Notes:
	Directory: TSP Branch and Bound 
		* This is where the program I am submitting is stored.
		In it is also a series of randomly generated test cases
		that can be used.
	Directory: TSP (output validation)
		* This contains a single .cpp file that is meant to 
		check out output of the brand and bound method. The
	...
	Directory: Generate New Node Tests
		* Generate new test files. If this option is used, after
